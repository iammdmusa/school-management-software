...
class Admin_model extends CI_Model {
   function __construct()
    ...
    function admin_login_check_front($email,$password,$user_type)
    {
       $sql = "SELECT * FROM scl_admin WHERE email = '$email' AND password = '$password' AND is_superadmin='$user_type' AND status = 1 LIMIT 1"; 
       $query = $this->db->query($sql);
       $res = $query->row_array();
       return $res;
    }
    ...
    function get_greeting_sms_student_info($school_id)
    {
       $sql = "SELECT s.school_id,
                      ...
                      std.roll_no
               FROM scl_school s
               INNER JOIN scl_student std ON std.school_id = s.school_id
               WHERE std.status = 1
    ...
    function get_school_sentsms_info()
    {
        $sql = "SELECT a.no_of_sms,
                       a.school_id,                     
                       s.school_name
                FROM scl_sms_count a
                INNER JOIN scl_school s ON s.school_id = a.school_id
                ORDER BY s.school_name ASC";  
        $query = $this->db->query($sql);
        $res = $query->result_array();
    ...
    /*new for teacher details*/
    function get_teacher_detail($teacher_id,$school_id)
    {
        $sql = "SELECT * FROM scl_teacher WHERE teacher_id = $teacher_id AND school_id = $school_id LIMIT 1";
        $query = $this->db->query($sql);
        $res = $query->row_array();
        return $res; 
    }
    /*new for teacher details end*/
    ...
    function get_student_attendence_by_teacher12($school_id,$class_name_id,$section_id)
    {
            $curDate = date('Y-m-d',time());
            $sql = "SELECT s.student_id,
                           s.name,
                           ...
                           sa.is_message_sent
                    FROM scl_student s
                    INNER JOIN scl_attendance sa ON s.student_id = sa.student_id
                    WHERE sa.class_name_id = $class_name_id
                    AND sa.school_id = $school_id
                    AND s.section_id = $section_id
                    AND sa.status = 1
    ...
    function get_admin_settings_sms()
    {
       $sql = "SELECT * FROM scl_sms WHERE status = 1 LIMIT 1"; 
       $query = $this->db->query($sql);
       $res = $query->row_array();       
    ...
    function get_sms_teacher_list($school_id)
    {
       $sql = "SELECT * FROM scl_teacher WHERE status = 1 AND school_id = $school_id"; 
       $query = $this->db->query($sql);
       $res = $query->result_array();       
       return $res; 
    }
    function get_school_sms_teacher_list($school_id,$condition = '')
    {
       $sql = "SELECT scl_teacher.*,scl_school.sid FROM scl_teacher  
               LEFT JOIN scl_school ON scl_school.school_id = scl_teacher.school_id
               WHERE scl_teacher.status = 1 
               AND scl_teacher.school_id = $school_id 
               $condition"; 
    ...
    {
        $sql = "SELECT DISTINCT section_id FROM scl_class WHERE school_id = $school_id AND class_name_id = $class_name_id";
        $query = $this->db->query($sql);
        $res = $query->result_array(); 
        $str1 = '';
        ...
        if($res)
        {
           ...
           {
               $sql = "SELECT * FROM scl_section WHERE section_id IN ($comma_section_ids)"; 
               $query = $this->db->query($sql);
               $res = $query->result_array(); 
    ...
    function get_exam_list($school_id)
    {
        $sql = "SELECT * FROM scl_exam WHERE school_id = $school_id";
        $query = $this->db->query($sql);
        $res = $query->result_array();
        return $res;  
    }
    ...
    {
        $sql = "SELECT * FROM scl_class WHERE class_name_id = $class_name_id AND section_id = $section_id AND school_id = $school_id";
        $query = $this->db->query($sql);
        $res = $query->result_array(); 
        $str1 = '';
    ...
    function result_sheet_ajax_rs($school_id,$class_name_id,$section_id)
    {
        $sql = "SELECT * FROM scl_student WHERE class_name_id = $class_name_id AND section_id = $section_id AND school_id = $school_id ORDER BY roll_no ASC";
        $query = $this->db->query($sql);
        $res = $query->result_array(); 
        return $res;
    }
    
    function get_result_sheet_SMS_rs($school_id,$class_name_id,$section_id,$exam_id)
    {
        $sql = "SELECT s.student_id,
                       s.name,
                       s.roll_no,
                       ...
                       scl.sid
                FROM scl_student s
                INNER JOIN scl_student_result r on r.student_id = s.student_id
                INNER JOIN scl_class c on c.class_id = r.class_id
    ...
    function get_result_sheet_SMS_rs1($school_id,$class_name_id,$section_id,$exam_id)
    {
        $sql = "SELECT s.student_id,
                       s.name,
                       s.roll_no,
    ...
    function get_result_sheet_SMS_rs_v2($school_id,$class_name_id,$section_id,$exam_id)
    {
        $sql = "SELECT s.student_id,
                       s.name,
                       s.roll_no,
    ...
    function get_result_sheet_SMS_rs2($school_id,$class_name_id,$section_id,$exam_id)
    {
        $sql = "SELECT s.student_id,
                       s.name,
                       s.roll_no,
                ...
                AND r.exam_id = $exam_id
                GROUP BY s.student_id
                ORDER BY s.roll_no ASC,r.created_on DESC";
    ...
    function get_section_by_class_id($school_id,$class_name_id)
    {
        $sql = "SELECT c.class_name_id,
                       c.section_id,
                       s.section
                ...
                GROUP BY c.class_name_id";
        $query = $this->db->query($sql);
        $res = $query->result_array(); 
        return $res;
    }
    
    function student_list_ajax_migrated($school_id,$class_name_id,$section_id)
    {
        $sql = "SELECT s.student_id,
                       s.name,
                       s.gurdian_name,
