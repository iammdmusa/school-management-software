...
class Report_model extends CI_Model 
{
    ...
    function all_exam_list($school_id,$section_id,$class_id,$class_name_id)
    {
        $sql = "SELECT DISTINCT exam_id FROM scl_student_result WHERE class_name_id = $class_name_id AND school_id = $school_id AND section_id = $section_id AND class_id = $class_id";
        $query = $this->db->query($sql);
        $result = $query->result_array(); 
    ...
    function print_exam_list($class_name_id,$school_id,$section_id)
    {
        $sql = "SELECT DISTINCT exam_id FROM scl_student_result WHERE class_name_id = $class_name_id AND school_id = $school_id AND section_id = $section_id";
        $query = $this->db->query($sql);
        $result = $query->result_array(); 
    ...
    function get_student_list_pdf($school_id,$class_name_id,$section_id)
    {
       $sql = "SELECT * FROM scl_student WHERE school_id = $school_id AND class_name_id = $class_name_id AND section_id = $section_id ORDER BY roll_no ASC";
       $query = $this->db->query($sql);
       $res = $query->result_array(); 
       return $res;       
    }
