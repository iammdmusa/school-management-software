        ...
        <form id="validate" name="validate" class="form" method="post" action="">
            <fieldset>
                <div class="widget">
                    ...
                    <div class="formSubmit"><input type="button" value="SEND SMS" onclick="send_greeting_sms(<?php echo $greeting['greeting_id']?>); return false" class="redB" /></div>
                    <div class="clear"></div>
                </div>
