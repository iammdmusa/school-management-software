                ...
                <div class="widget">
                   ...
                   <div class="formRow" >
                    ...
                    <div class="formSubmit">
                            <input type="button" value="Send Message" class="redB messagesendAction" onclick="send_selected_message(); return false;" />
                            <!--input type="submit" value="Send Message" class="redB messagesendAction" />
                            <input type="button" value="Already Message Sent" class="redB messagesendDisable" /-->
                    </div>
            </fieldset>
        </form> 
