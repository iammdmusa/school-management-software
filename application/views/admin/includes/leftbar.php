    ...
    <ul id="menu" class="nav">
        ...
        <li class="forms"><a href="javascript:void(0);" title="" class="exp"><span>Result</span></a>
            <ul class="sub">
               ...
               <li><a href="<?php echo BASEURL?>result/edit_result" title="">Edit Result</a></li>
               <li><a href="<?php echo BASEURL?>create/student_result" title="">View Result</a></li>
<!--               <li><a href="<?php echo BASEURL?>report/print_page" title="">Print Result</a></li>-->
            </ul>
        </li>
        ...
        <li class="forms"><a href="javascript:void(0);" title="" class="exp"><span>Exam</span></a>
            <ul class="sub">
               ...
               <li><a href="<?php echo BASEURL; ?>exam/list_exam" title="">Exam List</a></li>
            </ul>
        </li>
        ...
        <li class="forms"><a href="javascript:void(0);" title="" class="exp"><span>MIGRATION</span></a>
            <ul class="sub">
               <li><a href="<?php echo BASEURL?>create/class_migration" title="">Class Migration</a></li>
               <li><a href="<?php echo BASEURL?>create/class_migrated" title="">Migrated Class</a></li>
            </ul>
        </li>
