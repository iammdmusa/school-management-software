...
<script type="text/javascript" src="<?php echo BASEURL?>admin-img-css-js/js/plugins/charts/excanvas.min.js"></script>
<script type="text/javascript" src="<?php echo BASEURL?>admin-img-css-js/js/plugins/charts/jquery.sparkline.min.js"></script>
...
<div class="loginWrapper">
    <div class="loginLogo"><img style="margin-left:20px" src="<?php echo BASEURL?>admin-img-css-js/images/logo.png" alt="" /></div>
    <div class="widget">
        <div class="title"><img src="<?php echo BASEURL?>admin-img-css-js/images/icons/dark/files.png" alt="" class="titleIcon" /><h6>Login panel</h6></div>
        <form action="<?php echo BASEURL?>admin/login" id="loginFrm" name="loginFrm" class="form" method="post">
            <fieldset>
                <div class="formRow">
                    <label for="login">Email:</label>
                    <div class="loginInput"><input type="text" name="email" id="email" required="1"  realName="email"  regexp="JSVAL_RX_EMAIL" /></div>
                    <div class="clear"></div>
                </div>
                
                <div class="formRow">
                    <label for="pass">Password:</label>
                    <div class="loginInput"><input type="password" name="password"  id="password" required="1"  realName="password" /></div>
                    <div class="clear"></div>
                </div>
                
                <div class="loginControl">
                    <div class="rememberMe"><input type="checkbox" id="remMe" name="remMe" /><label for="remMe">Remember me</label></div>
                    <input type="button" value="Log me in" class="dredB logMeIn" onclick="set_user_loggedin(); return false;" />
                    <div class="clear"></div>
                </div>
            </fieldset>
        </form>
...
{
    if(validateStandard(document.forms.loginFrm))
    {
