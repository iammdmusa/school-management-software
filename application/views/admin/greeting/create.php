                ...
                <div class="widget">
                    <div class="title"><h6>Update SMS</h6></div>
                     ...
                     <div class="formRow" >
                        ...
                        <div class="formRight">
                            <span class="oneThree">
                                <input type="text" id="greeting_title" name="greeting_title" class="validate[required]" />
                            </span>
                        </div>
                        <div class="clear"></div>
                    </div>
                    ...
                    <div class="formRow" >
                        ...
                        <div class="formRight">
                            <span class="oneThree">
                                <##STUDENTNAME##><br/>
                                <textarea maxlength="160" name="greeting" id="greeting" class="validate[required]" style="width:500px;height:50px;resize:none;" ></textarea>
                            </span>
                        </div>
                        <div class="clear"></div>
                    </div>
