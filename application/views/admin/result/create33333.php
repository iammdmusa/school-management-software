            ...
            <fieldset>
                <div class="widget">
                    ...
                    <div class="formRow" >
                        ...
                        <div class="formRight">
                            <span class="oneThree">
                                <select id="class_name_id" name="class_name_id" onclick="get_class_subject(this.value);"> 
                     ...
                     <div class="formRow" >
                        ...
                        <div class="formRight">
                            <span class="oneThree">
                                <select id="class_id" name="class_id" onclick="get_result_sheet(this.value);"> 
                                    <option value="" >Select One</option>
                                </select>                            
                            </span>
                        </div>
                   ...
                   <div class="formRow" >
                        <div class="custom_table" id="student_result_list"></div>
                        <div class="clear"></div>
                   </div>      
