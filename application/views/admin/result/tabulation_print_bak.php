...
<head>
	<style>
        ...
        .bg{background-color:#fff;max-width:100%;margin:0 auto 0px auto;padding-left:20px;padding-right:20px;border-radius:5px;}
                                    ...
                                    <tr>
                                        ...
                                        <?php if($student->result_summary): ?>
                                            <?php foreach($student->result_summary as $summary): ?>
                                                <td><?php echo $summary->marks; ?></td>
                                                <td><?php echo $summary->position; ?></td>
                                                <td><?php echo $summary->cgpa; ?></td>
                                            <?php endforeach; ?>
                                        <?php else: ?>
                                            <td>No Results found</td>
                                            <td>No Results found</td>
