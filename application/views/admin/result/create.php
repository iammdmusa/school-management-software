...
<!-- Validation form -->
                ...
                <div class="widget">
                    ...
                    <div class="formRow" >
                        ...
                        <div class="divBox">
                            ...
                            <div class="selectionBox">
                                <select id="class_id" name="class_id" onchange="get_exam_list(this.value);"> 
                                    <option value="">Select One</option>
                                </select> 
                            </div>
        ...
        <script>
        function get_exam_list(class_id)
        {
            var class_name_id = $('#class_name_id').val();
            var section_id = $('#section_id').val();
            $.ajax({
                type: "POST",
                url: baseUrl+'result/get_exam_name_list_ajax',
                data:
                {
