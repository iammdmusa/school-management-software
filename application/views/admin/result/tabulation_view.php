							...
							<tr>
								...
								<?php if($student->results): ?>
									<?php foreach($student->results as $result): ?>
										<td>
											<input id="marks_<?php echo $result->student_result_id; ?>" type="text" name="marks_<?php echo $result->student_result_id; ?>" value="<?php echo $result->marks; ?>"  style="width:40px;" class="subject_marks" data="<?php echo $result->student_result_id; ?>">
										</td>
										<td>
