...
if(!function_exists('get_letter_grade'))
{
    function get_letter_grade($grade_point)
    {
        ...
        else if($grade_point>=4.00 && $grade_point<4.50)
        {
           return 'A-'; 
        }
        else if($grade_point>=3.50 && $grade_point<4.00)
        {
           return 'B+'; 
        }
        else if($grade_point>=3.00 && $grade_point<3.50)
        {
           return 'B'; 
        }
        else if($grade_point>=2.50 && $grade_point<3.00)
        {
           return 'C'; 
        }
        else
